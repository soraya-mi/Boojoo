...
class HomePageBodySportPrivate extends StatefulWidget {
  @override
  _HomePageBodySportPrivateState createState() => _HomePageBodySportPrivateState();
}

class _HomePageBodySportPrivateState extends State<HomePageBodySportPrivate> {
  ...
  _fetchchallenge() async{
    ...
    _apiResponse = (await service.getchallenge_pr_sport()) as APIresponse<List<challenge_for_list>>;
