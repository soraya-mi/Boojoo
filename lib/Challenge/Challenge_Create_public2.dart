...
class challenge_create_public2 extends StatefulWidget {
  ...
  final String end;
  final String p_or_p;
  const challenge_create_public2({Key key,this.challengeid, this.title, this.descrip, this.like, this.start,
    this.end, this.p_or_p}): super (key: key);

  @override
  _challenge_create_public2State createState() => _challenge_create_public2State();

}

class _challenge_create_public2State extends State<challenge_create_public2> {
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async{
                      if (IsEditing)
                      {
                        ...
                        final result = await ch_detail_service.createchallengepublic(challenge);
