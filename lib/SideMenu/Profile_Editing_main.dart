...
class _profilePage_MainState extends State<profilePage_Main> {
  ...
  String imageDefiner(){
    String tmpPath;
    Timer(Duration(seconds: 2), ()async {
      final String returnie=await ProfilePrefs.getStringValuesSF("PathProfilePicture");
            ...
            children: <Widget>[
              ...
              Container(
                child:ListTile(
                  ...
                  title:Text( "ویرایش",textAlign: TextAlign.right,),
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      isInternetConnected();
                      _futureAlbumEditProfile =  CreatAlbumProfile(EditedUserName.text,
                          EditEmail.text);
